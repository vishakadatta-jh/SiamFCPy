...
def main():
    ...
    filename, image, templates_z, scores, candidate_scores = siam.build_tracking_graph(final_score_sz, design, env)
    ...
    if evaluation.video == 'all':
        ...
        for i in range(nv):
            ...
            for j in range(evaluation.n_subseq):
                ...
                bboxes, speed[idx] = tracker(hp, run, design, frame_name_list_, pos_x, pos_y,
                                             ...
                                             image, templates_z, scores, start_frame, candidate_scores)
        ...
        bboxes, speed = tracker(hp, run, design, frame_name_list, pos_x, pos_y, target_w, target_h, final_score_sz,
                                filename, image, templates_z, scores, evaluation.start_frame, candidate_scores)
